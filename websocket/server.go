...
func (u *Upgrader) Upgrade(w http.ResponseWriter, r *http.Request, responseHeader http.Header) (*Conn, error) {
	...
	// this is commented out, seriously can't figure out any other way to disable this check in
	// gorilla without copying the entire package and manually doing it.
	// help.
